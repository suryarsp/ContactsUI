...
import { IChatContainerProps } from "../../interfaces/contacts/IChatContainerProps";
import { IChatContainerState } from "../../interfaces/contacts/IChatContainerState";
...
export default class ChatContainer extends React.Component<IChatContainerProps, IChatContainerState> {
    ...
    render() {
        const { selectedContact, loggedInContact }  = this.props;
                            ...
                            <Col md={6}>
                            {
                                message.messageType === MessageType.RECIEVED ? (
                                    ...
                                    <div className="avatar">
                                       <i> {loggedInContact.firstName} {loggedInContact.lastName}</i> 
                                     </div>
                                    </div>
